...
UWA library guidance indicates older doctoral theses are commonly held in storage/print and can be requested or digitized through library services.

Therefore the Siliquini thesis is now classified as an **actionable archival acquisition target**, not an unidentified reference.
